...
export const verificationForPinResetSchema = vine.object({ code: codeShema, token: jwtSchema });
...
export const newPinSchema = vine.object({ newPin: pinSchema, token: jwtSchema });
